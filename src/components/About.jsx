        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="flex flex-col justify-center">
            ...
            <p className="text-zinc-600 mb-6 leading-relaxed">
              I am <span className="font-bold text-gray-900">Ezekiel Bassey</span>, a passionate full-stack web developer dedicated to building websites that are fast, secure, and built to last. With a focus on building secure, custom architecture from the ground up, I understand what it takes to build a successful online presence.
            </p>
            <p className="text-zinc-600 mb-8 leading-relaxed">
              My approach combines robust engineering, strategic thinking, and modern technology to deliver solutions that not only look beautiful but also drive real impact for your business.
            </p>
