            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center gap-4 text-white">
                ...
                <div>
                  ...
                  <a href="https://wa.me/1234567890" target="_blank" rel="noopener noreferrer" className="text-lg font-semibold hover:text-green-400 transition-colors">+1 (234) 567-890</a>
                </div>
              </div>
            </div>
          </motion.div>
