        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-10 mb-12">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <div className="flex space-x-4">
              <a href="https://github.com/ezekielbassey28-hub" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-primary hover:text-white transition-colors border border-white/10">
                <i className="fab fa-github"></i>
              </a>
              <a href="https://www.linkedin.com/in/ezekiel-bassey-206b25395" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-primary hover:text-white transition-colors border border-white/10">
